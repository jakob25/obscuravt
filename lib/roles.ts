...
export const ROLE_DEFAULT_WIDGETS: Record<AppRole, WidgetId[]> = {
  Fan: ['daily_loop', 'my_clips', 'trending_clips', 'find_my_oshi', 'forums', 'active_bets'],
  Creator: ['daily_loop', 'my_clips', 'trending_clips', 'tag_validator', 'leaderboard', 'active_bets'],
  VTuber: ['daily_loop', 'recent_notifications', 'active_bets', 'leaderboard', 'tag_validator', 'featured_vtubers'],
}

/** Widgets a role is allowed to add in the customizer */
export const ROLE_ALLOWED_WIDGETS: Record<AppRole, WidgetId[]> = {
  Fan: ['daily_loop', 'my_clips', 'trending_clips', 'find_my_oshi', 'forums', 'active_bets', 'weekly_digest', 'leaderboard', 'recent_notifications', 'constellations', 'featured_vtubers'],
  Creator: ['daily_loop', 'my_clips', 'trending_clips', 'tag_validator', 'leaderboard', 'active_bets', 'forums', 'weekly_digest', 'recent_notifications', 'constellations', 'featured_vtubers', 'find_my_oshi'],
  VTuber: ['daily_loop', 'recent_notifications', 'active_bets', 'leaderboard', 'tag_validator', 'featured_vtubers', 'trending_clips', 'forums', 'weekly_digest', 'constellations', 'find_my_oshi', 'my_clips'],
}
