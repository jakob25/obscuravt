...
-- Seed niche clusters (with positions so NicheMap query + star rendering works)
insert into canonical_tags (id, category, name, color, description, position_x, position_y, content_tag_ids) values
('just_chatting', 'niche_cluster', 'Just Chatting', '#eab308', 'IRL, zatsudan, talking streams', -220, -140, ARRAY['talk','irl','chat']),
('gameplay', 'niche_cluster', 'Gameplay', '#22c55e', 'Specific games or variety gaming', 180, -90, ARRAY['game','fps','rpg']),
('music', 'niche_cluster', 'Music & Karaoke', '#a78bfa', 'Singing, instruments, covers', -30, 210, ARRAY['sing','music','karaoke']),
('creative', 'niche_cluster', 'Creative / Art', '#ec4899', 'Drawing, crafts, design streams', 260, 130, ARRAY['art','creative','design']),
('asmr', 'niche_cluster', 'ASMR & Chill', '#14b8a6', 'Relaxing, soft spoken, triggers', 40, -210, ARRAY['asmr','chill','relax'])
on conflict (id) do nothing;
